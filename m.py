...
TOKEN = '7037711980:AAH-b9sI-5G5_ibfiFyRw50Rkck1AopGKVc'
...
FORWARD_CHANNEL_ID = -1002213342540
CHANNEL_ID = -1002213342540
error_channel_id = -1002213342540
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.reply_to(message, "*Contact admin @madpychos*", parse_mode='Markdown')
    else:
